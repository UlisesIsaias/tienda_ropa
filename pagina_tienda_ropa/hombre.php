...
// Consulta SQL para obtener productos de la categoría 'hombre'
$sql = "SELECT id, nombre, precio, color, talla, imagen FROM productos WHERE categoria = 'hombre'";
